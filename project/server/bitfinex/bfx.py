...
symlong = ['BTC', 'BCH', 'BSV', 'BTG', 'DSH', 'EOS', 'ETC', 'ETH', 'ETP', 'IOT',
...
def bfxws_data_handler(data):
    if isinstance(data, list):
        ...
        if not isinstance(dataEvent, str) and bfx.ws.subscriptionManager.is_subscribed(chan_id):
