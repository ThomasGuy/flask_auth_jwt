...
class TestAuthBlueprint(BaseTestCase):
    def test_registration(self):
        ...
        with self.client:
            ...
            self.assertFalse(
                is_token_revoked(decode_token(data_register["access_token"]))
            )
    ...
    def test_registered_with_already_registered_user(self):
        ...
        with self.client:
            ...
            self.assertTrue(
                data["message"] == "User/email already exists. Please Log in."
            )
    ...
    def test_refresh_expired_token(self):
        ...
        with self.client:
            ...
            refresh_response = self.client.get(
                "/auth/refresh",
                headers=dict(Authorization="Bearer " + data_login["refresh_token"]),
            )
